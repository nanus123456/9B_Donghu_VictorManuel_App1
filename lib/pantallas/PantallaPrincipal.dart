...
class PantallaPrincipal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            Column(
              ...
              children: [
                ...
                (
                  ...
                  child: Text(
                  "Compra en la tienda oficial de adidas desde tu computador o celular. Envío a todo México. Suscríbete y obtén un 15% de descuento en tu compra. Paga en línea. Envío a todo México.",
      ...
      backgroundColor: Color.fromARGB(47, 18, 165, 181),
    );
  }
}
